...
func (s *Store) validateSchema(ctx context.Context) error {
	...
	for _, trigger := range []string{
		...
		"postbuild_amendment_checkpoint_snapshots_immutable_delete",
		...
		"publication_evidence_immutable_update",
		"publication_evidence_immutable_delete",
		"publication_evidence_rebinds_immutable_update",
		"publication_evidence_rebinds_immutable_delete",
		"publication_transition_evidence_immutable_update",
		"publication_transition_evidence_immutable_delete",
		"runner_recovery_ledger_immutable_update",
		"runner_recovery_ledger_immutable_delete",
		"runner_start_authorities_immutable_update",
		"runner_start_authorities_immutable_delete",
		"ci_observations_immutable_update",
		"ci_observations_immutable_delete",
		"ci_observation_checks_immutable_update",
		"ci_observation_checks_immutable_delete",
		"ci_transition_evidence_immutable_update",
		"ci_transition_evidence_immutable_delete",
		"ci_transition_evidence_requires_checks",
		"ci_required_check_policies_immutable_update",
		...
		"final_review_repair_boundaries_immutable_delete",
		"verification_amendment_requests_immutable_update",
		"verification_amendment_requests_immutable_delete",
		"verification_revisions_immutable_update",
		"verification_revisions_immutable_delete",
		"guarded_merge_observations_immutable_update",
		"guarded_merge_observations_immutable_delete",
		"merge_intents_immutable_update",
		"merge_intents_immutable_delete",
		"ci_poll_schedules_immutable_update",
		"ci_poll_schedules_immutable_delete",
		"ci_poll_attempts_immutable_update",
		"ci_poll_attempts_immutable_delete",
		"ci_poll_retry_epochs_immutable_update",
		"ci_poll_retry_epochs_immutable_delete",
		"provider_phase_entries_immutable_update",
		"provider_phase_entries_immutable_delete",
		"provider_phase_attempt_entries_immutable_update",
		"provider_phase_attempt_entries_immutable_delete",
		"provider_retry_epochs_immutable_update",
		"provider_retry_epochs_immutable_delete",
		"project_configurations_immutable_update",
		"project_configurations_immutable_delete",
		"projects_config_generation_forward",
		"external_cleanup_checkpoints_immutable_update",
	...
	for _, trigger := range []string{"manual_merge_observations_immutable_update", "manual_merge_observations_immutable_delete"} {
		var count int
		if err := s.db.QueryRowContext(ctx, `SELECT COUNT(*) FROM sqlite_master WHERE type='trigger' AND name=?`, trigger).Scan(&count); err != nil || count != 1 {
			return fmt.Errorf("required trigger %s is missing", trigger)
		}
...
var requiredCompositeForeignKeys = []compositeForeignKeyRequirement{
	...
	compositeForeignKey("postbuild_amendment_checkpoint_snapshots", "provider_attempt_results",
		foreignKeyColumn{"channel", "channel"}, foreignKeyColumn{"project_id", "project_id"}, foreignKeyColumn{"ticket_id", "ticket_id"}, foreignKeyColumn{"reviewer_phase", "phase"}, foreignKeyColumn{"reviewer_role", "role"}, foreignKeyColumn{"reviewer_attempt", "attempt"}, foreignKeyColumn{"reviewer_attempt_id", "provider_attempt_id"}),
	compositeForeignKey("postbuild_amendment_checkpoint_snapshots", "repository_command_results",
		foreignKeyColumn{"command_semantic_key", "semantic_key"}, foreignKeyColumn{"command_claim_epoch", "claim_epoch"}),
	compositeForeignKey("postbuild_amendment_snapshots", "verification_amendment_requests",
		foreignKeyColumn{"channel", "channel"}, foreignKeyColumn{"project_id", "project_id"}, foreignKeyColumn{"ticket_id", "ticket_id"}, foreignKeyColumn{"amendment_transition_version", "transition_ticket_version"}),
	compositeForeignKey("postbuild_amendment_snapshots", "postbuild_repair_entries",
		foreignKeyColumn{"channel", "channel"}, foreignKeyColumn{"project_id", "project_id"}, foreignKeyColumn{"ticket_id", "ticket_id"}, foreignKeyColumn{"repair_entry_version", "entry_ticket_version"}),
	compositeForeignKey("postbuild_amendment_snapshots", "provider_attempts",
		foreignKeyColumn{"channel", "channel"}, foreignKeyColumn{"project_id", "project_id"}, foreignKeyColumn{"ticket_id", "ticket_id"}, foreignKeyColumn{"builder_phase", "phase"}, foreignKeyColumn{"builder_role", "role"}, foreignKeyColumn{"builder_attempt", "attempt"}, foreignKeyColumn{"builder_attempt_id", "id"}),
	compositeForeignKey("postbuild_amendment_snapshots", "provider_attempt_results",
		foreignKeyColumn{"channel", "channel"}, foreignKeyColumn{"project_id", "project_id"}, foreignKeyColumn{"ticket_id", "ticket_id"}, foreignKeyColumn{"builder_phase", "phase"}, foreignKeyColumn{"builder_role", "role"}, foreignKeyColumn{"builder_attempt", "attempt"}, foreignKeyColumn{"builder_attempt_id", "provider_attempt_id"}),
	compositeForeignKey("postbuild_amendment_snapshots", "verification_revisions",
	...
	compositeForeignKey("provider_phase_attempt_entries", "provider_phase_entries",
		foreignKeyColumn{"channel", "channel"}, foreignKeyColumn{"project_id", "project_id"}, foreignKeyColumn{"ticket_id", "ticket_id"}, foreignKeyColumn{"phase", "phase"}, foreignKeyColumn{"entry_ticket_version", "entry_ticket_version"}),
	compositeForeignKey("provider_phase_attempt_entries", "provider_attempts",
		foreignKeyColumn{"channel", "channel"}, foreignKeyColumn{"project_id", "project_id"}, foreignKeyColumn{"ticket_id", "ticket_id"}, foreignKeyColumn{"phase", "phase"}, foreignKeyColumn{"role", "role"}, foreignKeyColumn{"attempt", "attempt"}, foreignKeyColumn{"provider_attempt_id", "id"}),
	compositeForeignKey("provider_phase_attempt_entries", "phase_runs",
		foreignKeyColumn{"channel", "channel"}, foreignKeyColumn{"project_id", "project_id"}, foreignKeyColumn{"ticket_id", "ticket_id"}, foreignKeyColumn{"phase", "phase"}, foreignKeyColumn{"attempt", "attempt"}),
	compositeForeignKey("provider_retry_epochs", "provider_phase_entries",
		foreignKeyColumn{"channel", "channel"}, foreignKeyColumn{"project_id", "project_id"}, foreignKeyColumn{"ticket_id", "ticket_id"}, foreignKeyColumn{"phase", "phase"}, foreignKeyColumn{"entry_ticket_version", "entry_ticket_version"}),
	...
	compositeForeignKey("final_review_repair_boundaries", "ticket_budget_uses",
		foreignKeyColumn{"channel", "channel"}, foreignKeyColumn{"project_id", "project_id"}, foreignKeyColumn{"ticket_id", "ticket_id"}, foreignKeyColumn{"correction_budget_kind", "kind"}, foreignKeyColumn{"correction_budget_request_id", "request_id"}, foreignKeyColumn{"consumed_ticket_version", "ticket_version"}, foreignKeyColumn{"consumed_leader_epoch", "leader_epoch"}, foreignKeyColumn{"consumed_runner_epoch", "runner_epoch"}),
	compositeForeignKey("verification_amendment_requests", "ticket_budget_uses",
		foreignKeyColumn{"channel", "channel"}, foreignKeyColumn{"project_id", "project_id"}, foreignKeyColumn{"ticket_id", "ticket_id"}, foreignKeyColumn{"correction_budget_kind", "kind"}, foreignKeyColumn{"correction_budget_request_id", "request_id"}, foreignKeyColumn{"consumed_ticket_version", "ticket_version"}, foreignKeyColumn{"consumed_leader_epoch", "leader_epoch"}, foreignKeyColumn{"consumed_runner_epoch", "runner_epoch"}),
	compositeForeignKey("verification_amendment_requests", "provider_attempts",
		foreignKeyColumn{"channel", "channel"}, foreignKeyColumn{"project_id", "project_id"}, foreignKeyColumn{"ticket_id", "ticket_id"}, foreignKeyColumn{"builder_result_phase", "phase"}, foreignKeyColumn{"builder_result_role", "role"}, foreignKeyColumn{"builder_attempt", "attempt"}, foreignKeyColumn{"builder_attempt_id", "id"}),
	compositeForeignKey("verification_amendment_requests", "provider_attempt_results",
		foreignKeyColumn{"channel", "channel"}, foreignKeyColumn{"project_id", "project_id"}, foreignKeyColumn{"ticket_id", "ticket_id"}, foreignKeyColumn{"builder_result_phase", "phase"}, foreignKeyColumn{"builder_result_role", "role"}, foreignKeyColumn{"builder_attempt", "attempt"}, foreignKeyColumn{"builder_attempt_id", "provider_attempt_id"}),
...
var requiredForeignKeys = []foreignKeyRequirement{
	...
	{table: "guarded_merge_observations", target: "tickets"},
	{table: "guarded_merge_observations", target: "merge_intents"},
	{table: "guarded_merge_observations", target: "effects"},
	...
	{table: "verification_amendment_requests", target: "tickets"},
	{table: "verification_amendment_requests", target: "verification_revisions"},
	{table: "verification_amendment_requests", target: "provider_attempts"},
...
var requiredSchema = map[string][]string{
	...
	"provider_phase_entries":                   {"channel", "project_id", "ticket_id", "phase", "entry_ticket_version", "entry_event_id", "entry_event_created_at", "entry_leader_epoch", "entry_runner_epoch", "entry_from_state", "entry_state", "entry_trigger", "entry_digest", "created_at"},
	"provider_phase_attempt_entries":           {"provider_attempt_id", "channel", "project_id", "ticket_id", "phase", "role", "attempt", "entry_ticket_version", "created_at"},
	"provider_retry_epochs":                    {"channel", "project_id", "ticket_id", "phase", "entry_ticket_version", "epoch", "initial_first_attempt", "initial_last_attempt", "retry_first_attempt", "retry_last_attempt", "exhaustion_ticket_version", "exhaustion_leader_epoch", "exhaustion_runner_epoch", "retry_ticket_version", "retry_leader_epoch", "retry_runner_epoch", "retry_digest", "created_at"},
	...
	"guarded_merge_observations":               {"semantic_key", "channel", "project_id", "ticket_id", "request_digest", "ticket_version", "leader_epoch", "runner_epoch", "claim_epoch", "repository_host", "repository_owner", "repository_name", "pull_request_number", "head_owner", "head_repository", "head_ref", "head_oid", "base_ref", "original_base_oid", "merge_oid", "observed_state", "observed_merged", "observed_draft", "observed_factory_owned", "observed_merge_commit", "observed_base_oid", "observed_base_head_oid", "protection_rule_id", "protection_kind", "protection_checks_digest", "strict_status_checks", "admin_enforced", "active_ruleset_count", "method", "observation_digest", "created_at"},
	"external_mutation_quarantine":             {"singleton", "reason", "observed_at"},
	"external_cleanup_recovery_checkpoints":    {"quarantine_observed_at", "checkpoint", "checkpoint_digest"},
	"external_cleanup_recoveries":              {"quarantine_observed_at", "checkpoint_digest", "recovery", "recovery_digest"},
	...
	"git_mutation_leases":                      {"repository_path", "semantic_key", "nonce", "state", "launch_state", "process_pid", "process_pgid", "process_boot_identity", "process_start_identity", "prepared_commit_oid", "prepared_tree_oid", "prior_remote_observed", "prior_remote_oid", "observation_only"},
...
var requiredIndexes = []indexRequirement{
	...
	{table: "postbuild_amendment_snapshots", name: "postbuild_amendment_snapshots_binding", columns: []string{"binding_digest"}},
	...
	{table: "verification_amendment_requests", name: "verification_amendment_requests_ticket", columns: []string{"channel", "project_id", "ticket_id", "transition_ticket_version"}, nonUnique: true},
	{table: "guarded_merge_observations", name: "guarded_merge_observations_ticket", columns: []string{"channel", "project_id", "ticket_id", "created_at"}, nonUnique: true},
